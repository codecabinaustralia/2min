class SitesController < ApplicationController
  ...
  def create_temp_site
    ...
    @site = Site.new(
      ...
      home_town: "Sydney",
      location_text: "We service all areas of Sydney and surrounding suburbs. Call now and see if we can service your area.",
      phone: "0400 000 000",
    ...
    email, name, temporary_password = "info@theblackandwhites.com.au", 'Alice', 'Test123'

    begin
      CreateSend::Subscriber.add(auth, list_id, email, name, temporary_password, false, false, false)

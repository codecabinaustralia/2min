class AdditionalServicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @additional_service.save
        format.html { redirect_to new_additional_service_path, notice: 'Additional service was successfully created.' }
  ...
  private
    ...
    def additional_service_params
      params.require(:additional_service).permit(:title, :trade_id)
    end
end

...
class ColorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create color" do
    assert_difference('Color.count') do
      post colors_url, params: { color: { color_1: @color.color_1, color_2: @color.color_2 } }
    end
  ...
  test "should update color" do
    patch color_url(@color), params: { color: { color_1: @color.color_1, color_2: @color.color_2 } }

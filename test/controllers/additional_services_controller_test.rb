...
class AdditionalServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create additional_service" do
    assert_difference('AdditionalService.count') do
      post additional_services_url, params: { additional_service: { title: @additional_service.title, trade_id: @additional_service.trade_id } }
    end
  ...
  test "should update additional_service" do
    patch additional_service_url(@additional_service), params: { additional_service: { title: @additional_service.title, trade_id: @additional_service.trade_id } }
